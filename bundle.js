...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    key: "leaderboardSearch",
	    value: function leaderboardSearch() {
	      var _this2 = this;
	
	      $.get("https://fcctop100.herokuapp.com/api/fccusers/top/recent", function (data) {
	        _this2.setState({ month: data });
	      }); //End get request
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement(Table, { month: this.state.month,
	          onChangeAT: function onChangeAT() {
	            $.get("https://fcctop100.herokuapp.com/api/fccusers/top/alltime", function (data) {
	              _this3.setState({ month: data });
	            }); //End get request
	          } //Anon function
	          ,
	          onChangeNow: function onChangeNow() {
	            $.get("https://fcctop100.herokuapp.com/api/fccusers/top/recent", function (data) {
	              _this3.setState({ month: data });
	            }); //End get request
	          } //Anon function
	...
	var Table = function Table(props) {
	  ...
	  for (var i in month) {
	    display_month.push(_react2.default.createElement(Table_rows, { key: i, rank: Number(i) + 1, user: month[i] }));
	  }
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "th",
	        { className: "recent_list", onClick: function onClick() {
	            return props.onChangeNow();
	          } },
	        _react2.default.createElement(
	          "a",
	          null,
	      ...
	      _react2.default.createElement(
	        "th",
	        { className: "alltime_list", onClick: function onClick() {
	            return props.onChangeAT();
	          } },
	        _react2.default.createElement(
	          "a",
	          null,
	...
	var Table_rows = function Table_rows(props) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      "td",
	      { className: "table_username" },
	      _react2.default.createElement("img", { className: "avatar", src: image }),
	      _react2.default.createElement(
	        "a",
